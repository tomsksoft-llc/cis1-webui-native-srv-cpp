...
struct detail
{
    static decltype(auto) make_database(const char* path)
    {
        ...
        return make_storage(
                ...
                make_table("projects_group_rights",
                    make_column("projects_group_right_id", &projects_group_right::id, autoincrement(), primary_key()),
                    make_column("projects_group_right_group_id", &projects_group_right::group_id),
                    make_column("projects_group_right_read", &projects_group_right::read),
                    make_column("projects_group_right_write", &projects_group_right::write),
                    make_column("projects_group_right_execute", &projects_group_right::execute),
                    foreign_key(&projects_group_right::group_id).references(&group::id).on_delete.cascade()),
                make_table("tokens",
