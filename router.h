...
public:
    ...
    void add_route(std::string route, std::function<void(http::request<http::string_body>&&, http_session_queue&)> handle_cb);
    void add_catch_route(std::function<void(http::request<http::string_body>&&, http_session_queue&)> handle_cb);
...
private:
    std::vector<std::pair<boost::regex, std::function<void(http::request<http::string_body>&&, http_session_queue&)>>> routes_;
